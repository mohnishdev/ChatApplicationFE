...
import { LoginuserAction } from "../../Actions/Action/LoginUSerAction/LoginUserAction";
// import "./login.css"

const LoginPage = ({setForgotPassword , setSwitch}) => {
    ...
    const handleLogin = async (e) => {
        ...
        if (email.value === "" && password.value === "") {
            ...
            dispatch(LoginuserAction(user)).then((data) =>{
    ...
    return (
        ...
        <span className="form__span">or use your email account</span> */}
            <input type="email" name="email" className="form__input"  placeholder="name@example.com" />
            <input type="password" name="password" className="form__input"  placeholder="● ● ● ● ● ● ● ● ●" />
            {/* <small onClick={handleforgot} className="form__link" >Forgot your password?</small> */}
