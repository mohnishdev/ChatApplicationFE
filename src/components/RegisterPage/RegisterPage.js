...
import { RegisteruserAction } from "../../Actions/Action/RegisterUserAction/RegisterUserAction"
...
const RegisterPage = () => {
    ...
    const collectData = async (e) => {
        ...
        dispatch(RegisteruserAction(newUser)).then((data) => {
    ...
    return (
        <form className="form" id="a-form" onSubmit={collectData}>
            ...
            <input type="text" readOnly={true} onFocus={(e) => handleFocus(e)} className="form__input" name="userName" placeholder="Enter Name" onChange={(e) => setName(e.target.value)} />
            <input type="email" className="form__input" name="userEmail" placeholder="Enter email" onChange={(e) => setEmail(e.target.value)} />
            <input type="password" className="form__input" name="userPassword" placeholder="Enter Password" onChange={(e) => setPassword(e.target.value)} />
